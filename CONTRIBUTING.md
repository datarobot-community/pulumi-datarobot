...
Sections for released versions are generated by the upgrade workflow from the upstream
provider's changelog and a diff of the generated `schema.json` — don't hand-edit those.
