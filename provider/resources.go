...
import (
	...
	"github.com/datarobot-community/pulumi-datarobot/provider/pkg/version"
)
...
const (
	...
	mainPkg = "datarobot"
	// modules:
	mainMod = "index" // the datarobot module
)

//go:embed cmd/pulumi-resource-datarobot/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-datarobot/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-datarobot/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "datarobot", datarobot.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-datarobot/provider".New
		...
		//
		//nolint:lll
		P: pfbridge.ShimProvider(datarobot.New(version.Version)()),
		...
		Keywords:   []string{"datarobot", "ai", "category/cloud"},
		License:    "Apache-2.0",
	...
	prov.MustComputeTokens(tokens.SingleModule("datarobot_", mainMod,
