...
class GoogleCloudCredentialArgs:
    def __init__(__self__, *,
                 gcp_key: pulumi.Input[Optional[_builtins.str]] = None,
                 gcp_key_file: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a GoogleCloudCredential resource.

        :param pulumi.Input[_builtins.str] gcp_key: The GCP key in JSON format.
        :param pulumi.Input[_builtins.str] gcp_key_file: The file that has the GCP key. Cannot be used with <span pulumi-lang-nodejs="`gcpKey`" pulumi-lang-dotnet="`GcpKey`" pulumi-lang-go="`gcpKey`" pulumi-lang-python="`gcp_key`" pulumi-lang-yaml="`gcpKey`" pulumi-lang-java="`gcpKey`" pulumi-lang-hcl="`gcp_key`">`gcpKey`</span>.
        :param pulumi.Input[_builtins.str] name: The name of the Google Cloud Credential.
        """
    ...
    def gcp_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @gcp_key.setter
    def gcp_key(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "gcp_key", value)

    @_builtins.property
    @pulumi.getter(name="gcpKeyFile")
    def gcp_key_file(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @gcp_key_file.setter
    def gcp_key_file(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _GoogleCloudCredentialState:
    def __init__(__self__, *,
                 gcp_key: pulumi.Input[Optional[_builtins.str]] = None,
                 gcp_key_file: pulumi.Input[Optional[_builtins.str]] = None,
                 gcp_key_file_hash: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] gcp_key: The GCP key in JSON format.
        :param pulumi.Input[_builtins.str] gcp_key_file: The file that has the GCP key. Cannot be used with <span pulumi-lang-nodejs="`gcpKey`" pulumi-lang-dotnet="`GcpKey`" pulumi-lang-go="`gcpKey`" pulumi-lang-python="`gcp_key`" pulumi-lang-yaml="`gcpKey`" pulumi-lang-java="`gcpKey`" pulumi-lang-hcl="`gcp_key`">`gcpKey`</span>.
        :param pulumi.Input[_builtins.str] gcp_key_file_hash: The hash of the GCP key file contents.
        :param pulumi.Input[_builtins.str] name: The name of the Google Cloud Credential.
        """
        if gcp_key is not None:
            pulumi.set(__self__, "gcp_key", gcp_key)
    ...
    def gcp_key_file_hash(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def gcp_key_file_hash(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class GoogleCloudCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            gcp_key_file: pulumi.Input[Optional[_builtins.str]] = None,
            gcp_key_file_hash: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None) -> 'GoogleCloudCredential':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="gcpKeyFile")
    def gcp_key_file(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The file that has the GCP key. Cannot be used with <span pulumi-lang-nodejs="`gcpKey`" pulumi-lang-dotnet="`GcpKey`" pulumi-lang-go="`gcpKey`" pulumi-lang-python="`gcp_key`" pulumi-lang-yaml="`gcpKey`" pulumi-lang-java="`gcpKey`" pulumi-lang-hcl="`gcp_key`">`gcpKey`</span>.
        """
        return pulumi.get(self, "gcp_key_file")
    ...
    @_builtins.property
    @pulumi.getter(name="gcpKeyFileHash")
    def gcp_key_file_hash(self) -> pulumi.Output[_builtins.str]:
        """
        The hash of the GCP key file contents.
        """
        return pulumi.get(self, "gcp_key_file_hash")
