...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 prediction_environment_id: pulumi.Input[builtins.str],
                 registered_model_version_id: pulumi.Input[builtins.str],
                 ...
                 retraining_settings: Optional[pulumi.Input['DeploymentRetrainingSettingsArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] label: The label of the Deployment.
        :param pulumi.Input[builtins.str] prediction_environment_id: The ID of the predication environment for this Deployment.
        :param pulumi.Input[builtins.str] registered_model_version_id: The ID of the registered model version for this Deployment.
        ...
        :param pulumi.Input[builtins.str] importance: The importance of the Deployment.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] use_case_ids: The list of Use Case IDs to add the Deployment to.
        """
    ...
    def prediction_environment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def prediction_environment_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "prediction_environment_id", value)

    @property
    @pulumi.getter(name="registeredModelVersionId")
    def registered_model_version_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def registered_model_version_id(self, value: pulumi.Input[builtins.str]):
    ...
    def retraining_settings(self) -> Optional[pulumi.Input['DeploymentRetrainingSettingsArgs']]:
        """
    ...
    def retraining_settings(self, value: Optional[pulumi.Input['DeploymentRetrainingSettingsArgs']]):
...
class _DeploymentState:
    def __init__(__self__, *,
                 ...
                 predictions_data_collection_settings: Optional[pulumi.Input['DeploymentPredictionsDataCollectionSettingsArgs']] = None,
                 predictions_settings: Optional[pulumi.Input['DeploymentPredictionsSettingsArgs']] = None,
                 registered_model_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 retraining_settings: Optional[pulumi.Input['DeploymentRetrainingSettingsArgs']] = None,
                 runtime_parameter_values: Optional[pulumi.Input[Sequence[pulumi.Input['DeploymentRuntimeParameterValueArgs']]]] = None,
                 segment_analysis_settings: Optional[pulumi.Input['DeploymentSegmentAnalysisSettingsArgs']] = None,
                 use_case_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
    ...
    @property
    @pulumi.getter(name="registeredModelVersionId")
    def registered_model_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the registered model version for this Deployment.
        """
        return pulumi.get(self, "registered_model_version_id")
    ...
    @registered_model_version_id.setter
    def registered_model_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "registered_model_version_id", value)
...
class Deployment(pulumi.CustomResource):
    ...
    pulumi_type = "datarobot:index/deployment:Deployment"
    ...
    def __init__(__self__,
                 ...
                 registered_model_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 retraining_settings: Optional[pulumi.Input[Union['DeploymentRetrainingSettingsArgs', 'DeploymentRetrainingSettingsArgsDict']]] = None,
    ...
    def get(resource_name: str,
            ...
            runtime_parameter_values: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DeploymentRuntimeParameterValueArgs', 'DeploymentRuntimeParameterValueArgsDict']]]]] = None,
            segment_analysis_settings: Optional[pulumi.Input[Union['DeploymentSegmentAnalysisSettingsArgs', 'DeploymentSegmentAnalysisSettingsArgsDict']]] = None,
            use_case_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Deployment':
        """
    ...
    @property
    @pulumi.getter(name="predictionEnvironmentId")
    def prediction_environment_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the predication environment for this Deployment.
        """
        return pulumi.get(self, "prediction_environment_id")
    ...
    @property
    @pulumi.getter(name="registeredModelVersionId")
    def registered_model_version_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the registered model version for this Deployment.
        """
        return pulumi.get(self, "registered_model_version_id")
