...
def get_global_model(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Registered Model.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_global_model_output(name: Optional[pulumi.Input[builtins.str]] = None,
