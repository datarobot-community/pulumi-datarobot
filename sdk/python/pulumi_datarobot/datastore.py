...
class DatastoreArgs:
    def __init__(__self__, *,
                 ...
                 driver_id: pulumi.Input[Optional[_builtins.str]] = None,
                 fields: pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = None,
                 jdbc_url: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a Datastore resource.

        :param pulumi.Input[_builtins.str] canonical_name: The user-friendly name of the data store.
        :param pulumi.Input[_builtins.str] data_store_type: The type of data store.
        :param pulumi.Input[_builtins.str] connector_id: The identifier of the Connector if data*store*type is DR*CONNECTOR*V1
        :param pulumi.Input[_builtins.str] driver_id: The identifier of the DataDriver if data*store*type is JDBC or DR*DATABASE*V1
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]] fields: If the type is dr-database-v1, then the fields specify the configuration.
        :param pulumi.Input[_builtins.str] jdbc_url: The full JDBC URL (for example: jdbc:postgresql://my.dbaddress.org:5432/my_db).
        """
    ...
    def driver_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @driver_id.setter
    def driver_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "driver_id", value)

    @_builtins.property
    @pulumi.getter
    def fields(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]]:
        """
    ...
    @fields.setter
    def fields(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]]):
...
class _DatastoreState:
    def __init__(__self__, *,
                 ...
                 connector_id: pulumi.Input[Optional[_builtins.str]] = None,
                 data_store_type: pulumi.Input[Optional[_builtins.str]] = None,
                 driver_id: pulumi.Input[Optional[_builtins.str]] = None,
                 fields: pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = None,
                 jdbc_url: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dataStoreType")
    def data_store_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The type of data store.
        """
        return pulumi.get(self, "data_store_type")
    ...
    @data_store_type.setter
    def data_store_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "data_store_type", value)
...
class Datastore(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_jdbc = datarobot.Datastore("example_jdbc",
    ...
    def get(resource_name: str,
            ...
            driver_id: pulumi.Input[Optional[_builtins.str]] = None,
            fields: pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = None,
            jdbc_url: pulumi.Input[Optional[_builtins.str]] = None) -> 'Datastore':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dataStoreType")
    def data_store_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of data store.
        """
        return pulumi.get(self, "data_store_type")
    ...
    @_builtins.property
    @pulumi.getter
    def fields(self) -> pulumi.Output[Optional[Sequence[Mapping[str, _builtins.str]]]]:
        """
        If the type is dr-database-v1, then the fields specify the configuration.
        """
        return pulumi.get(self, "fields")
    ...
    @_builtins.property
    @pulumi.getter(name="jdbcUrl")
    def jdbc_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The full JDBC URL (for example: jdbc:postgresql://my.dbaddress.org:5432/my_db).
        """
        return pulumi.get(self, "jdbc_url")
