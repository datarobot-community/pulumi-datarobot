...
class ArtifactSource(dict):
    ...
    def __init__(__self__, *,
                 dir: builtins.str,
                 dir_hash: Optional[builtins.str] = None):
        """
        :param builtins.str dir: Path to the local directory containing application source files to upload.
        :param builtins.str dir_hash: SHA-256 fingerprint of `dir` contents, used to detect changes and skip re-upload when unchanged.
        """
    ...
    def dir_hash(self) -> Optional[builtins.str]:
        """
...
class ArtifactSpecContainerGroupContainer(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str image_uri: Docker image URI. Omit when using `image_build_config` on draft artifacts; required when status is `locked` and `image_build_config` is set.
...
class ArtifactSpecContainerGroupContainerEnvironmentVar(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name of the environment variable. Required when source is "string" or "dr-credential". Optional for "api-key": when omitted, the platform injects the token as DATAROBOT*API*TOKEN.
        :param builtins.str source: Source type: "string" for plain text values, "dr-credential" for DataRobot credentials, "api-key" for a platform-managed DataRobot API token. Defaults to "string".
...
class ArtifactSpecContainerGroupContainerImageBuildConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param 'ArtifactSpecContainerGroupContainerImageBuildConfigCodeRefArgs' code_ref: Reference to source code in the DataRobot catalog. Optional at create; required before image build or lock. When `source` is set, the provider uploads `source.dir` and populates this block.
...
class ArtifactSpecContainerGroupContainerImageBuildConfigCodeRef(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str catalog_id: Files API catalog ID (24-character hex).
        :param builtins.str catalog_version_id: Files API catalog version ID (24-character hex).
        """
...
class ArtifactSpecContainerGroupContainerImageBuildConfigDockerfile(dict):
    ...
    def __init__(__self__, *,
                 entrypoints: Optional[Sequence[builtins.str]] = None,
                 execution_environment_id: Optional[builtins.str] = None,
                 execution_environment_version_id: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 source: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] entrypoints: Entrypoint baked into the generated Dockerfile CMD. Required when source is `generated`.
        :param builtins.str execution_environment_id: Execution environment ID for the base Docker image. Required when source is `generated`.
        :param builtins.str execution_environment_version_id: Execution environment version ID that pins the base image. Required when source is `generated`.
        :param builtins.str path: Relative path to the Dockerfile in the source code. Used when source is `provided`. Defaults to `./Dockerfile`.
        :param builtins.str source: How the Dockerfile is obtained: `provided` (from source code) or `generated` (from an execution environment). Defaults to `provided`.
        """
        if entrypoints is not None:
            pulumi.set(__self__, "entrypoints", entrypoints)
    ...
    def execution_environment_id(self) -> Optional[builtins.str]:
        """
    ...
    def execution_environment_version_id(self) -> Optional[builtins.str]:
        """
...
class ArtifactSpecContainerGroupContainerLivenessProbe(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int success_threshold: Minimum consecutive successes for the probe to be considered successful after having failed.
...
class BatchPredictionJobDefinitionCsvSettings(dict):
    def __init__(__self__, *,
                 ...
                 quotechar: Optional[builtins.str] = None):
        """
        :param builtins.str delimiter: Fields are delimited by this character. Use the string tab to denote TSV (TAB separated values). Must be either a one-character string or the string tab.
        :param builtins.str encoding: Encoding for the CSV files.
        :param builtins.str quotechar: Fields containing the delimiter must be quoted using this character.
        """
    ...
    @property
    @pulumi.getter
    def quotechar(self) -> Optional[builtins.str]:
        """
...
class BatchPredictionJobDefinitionIntakeSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_store_id: Optional[builtins.str] = None,
                 dataset_id: Optional[builtins.str] = None,
                 endpoint_url: Optional[builtins.str] = None,
                 fetch_size: Optional[builtins.int] = None,
        ...
        """
        :param builtins.str type: Type of data source.
        :param builtins.str catalog: The name of specified database catalog for JDBC type.
        :param builtins.str credential_id: The ID of the credentials for S3 or JDBC data source.
        :param builtins.str data_store_id: The ID of the external data store connected to the JDBC data source.
        :param builtins.str dataset_id: The ID of the dataset to score for dataset type.
        :param builtins.str endpoint_url: Any non-default endpoint URL for S3 access.
        :param builtins.int fetch_size: Changing the fetchSize can be used to balance throughput and memory usage for JDBC type.
        :param builtins.str file: String path to file of scoring data for localFile type.
        :param builtins.str query: A self-supplied SELECT statement of the data set you wish to predict for JDBC type.
        :param builtins.str schema: The name of specified database schema for JDBC type.
        :param builtins.str table: The name of specified database table for JDBC type.
        :param builtins.str url: The URL to score (e.g.: s3://bucket/key) for S3 type.
        """
        pulumi.set(__self__, "type", type)
    ...
    def data_store_id(self) -> Optional[builtins.str]:
        """
    ...
    def fetch_size(self) -> Optional[builtins.int]:
        """
...
class BatchPredictionJobDefinitionOutputSettings(dict):
    ...
    def __init__(__self__, *,
                 catalog: Optional[builtins.str] = None,
                 create_table_if_not_exists: Optional[builtins.bool] = None,
                 credential_id: Optional[builtins.str] = None,
                 data_store_id: Optional[builtins.str] = None,
                 endpoint_url: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 schema: Optional[builtins.str] = None,
                 statement_type: Optional[builtins.str] = None,
                 table: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None,
                 update_columns: Optional[Sequence[builtins.str]] = None,
                 url: Optional[builtins.str] = None,
                 where_columns: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str catalog: The name of specified database catalog for JDBC type.
        :param builtins.bool create_table_if_not_exists: If no existing table is detected, attempt to create it before writing data for JDBC type.
        :param builtins.str credential_id: The ID of the credentials for S3 or JDBC data source.
        :param builtins.str data_store_id: The ID of the external data store connected to the JDBC data source.
        :param builtins.str endpoint_url: Any non-default endpoint URL for S3 access.
        :param builtins.str path: Path to save the scored data as CSV for localFile type.
        :param builtins.str schema: The name of specified database schema for JDBC type.
        :param builtins.str statement_type: The type of insertion statement to create for JDBC type.
        :param builtins.str table: The name of specified database table for JDBC type.
        :param builtins.str type: Type of output.
        :param Sequence[builtins.str] update_columns: A list of strings containing those column names to be updated for JDBC type.
        :param builtins.str url: The URL for storing the results (e.g.: s3://bucket/key) for S3 type.
        :param Sequence[builtins.str] where_columns: A list of strings containing those column names to be selected for JDBC type.
        """
        if catalog is not None:
            pulumi.set(__self__, "catalog", catalog)
    ...
    def create_table_if_not_exists(self) -> Optional[builtins.bool]:
        """
    ...
    def statement_type(self) -> Optional[builtins.str]:
        """
    ...
    def update_columns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def where_columns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BatchPredictionJobDefinitionPredictionInstance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 datarobot_key: Optional[builtins.str] = None,
                 ssl_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str host_name: Hostname of the prediction instance.
        :param builtins.str api_key: By default, prediction requests will use the API key of the user that created the job. This allows you to make requests on behalf of other users.
        :param builtins.str datarobot_key: If running a job against a prediction instance in the Managed AI Cloud, you must provide the organization level DataRobot-Key.
        :param builtins.bool ssl_enabled: Set to false to run prediction requests from the batch prediction job without SSL. Defaults to true.
        """
    ...
    def datarobot_key(self) -> Optional[builtins.str]:
        """
...
class BatchPredictionJobDefinitionTimeseriesSettings(dict):
    ...
    def __init__(__self__, *,
                 forecast_point: Optional[builtins.str] = None,
                 predictions_end_date: Optional[builtins.str] = None,
                 predictions_start_date: Optional[builtins.str] = None,
                 relax_known_in_advance_features_check: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str forecast_point: Forecast point for the dataset, used for the forecast predictions. May be passed if timeseries_settings.type=forecast.
        :param builtins.str predictions_end_date: End date for historical predictions. May be passed if timeseries_settings.type=historical.
        :param builtins.str predictions_start_date: Start date for historical predictions. May be passed if timeseries_settings.type=historical.
        :param builtins.bool relax_known_in_advance_features_check: If True, missing values in the known in advance features are allowed in the forecast window at the prediction time. Default is False.
        :param builtins.str type: Type of time-series prediction. Must be 'forecast' or 'historical'. Default is 'forecast'.
        """
    ...
    def forecast_point(self) -> Optional[builtins.str]:
        """
    ...
    def predictions_end_date(self) -> Optional[builtins.str]:
        """
    ...
    def predictions_start_date(self) -> Optional[builtins.str]:
        """
    ...
    def relax_known_in_advance_features_check(self) -> Optional[builtins.bool]:
        """
...
class CustomMetricFromJobSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 months: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] day_of_months: Days of the month when the metric job will run.
        :param Sequence[builtins.str] day_of_weeks: Days of the week when the metric job will run.
        :param Sequence[builtins.str] hours: Hours of the day when the metric job will run.
        :param Sequence[builtins.str] minutes: Minutes of the day when the metric job will run.
        :param Sequence[builtins.str] months: Months of the year when the metric job will run.
        """
        pulumi.set(__self__, "day_of_months", day_of_months)
        pulumi.set(__self__, "day_of_weeks", day_of_weeks)
        pulumi.set(__self__, "hours", hours)
...
class CustomMetricFromJobTimestamp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column_name: Column name.
        :param builtins.str time_format: Format.
        """
        if column_name is not None:
            pulumi.set(__self__, "column_name", column_name)
...
class CustomModelGuardConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 openai_api_base: Optional[builtins.str] = None,
                 openai_credential: Optional[builtins.str] = None,
                 openai_deployment_id: Optional[builtins.str] = None,
                 output_column_name: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str openai_api_base: The OpenAI API base URL for this guard.
        :param builtins.str openai_credential: The ID of an OpenAI credential for this guard.
        :param builtins.str openai_deployment_id: The ID of an OpenAI deployment for this guard.
        :param builtins.str output_column_name: The output column name of this guard.
        """
    ...
    def input_column_name(self) -> Optional[builtins.str]:
        """
    ...
    def llm_type(self) -> Optional[builtins.str]:
        """
    ...
    def openai_api_base(self) -> Optional[builtins.str]:
        """
    ...
    def openai_credential(self) -> Optional[builtins.str]:
        """
    ...
    def openai_deployment_id(self) -> Optional[builtins.str]:
        """
    ...
    def output_column_name(self) -> Optional[builtins.str]:
        """
...
class CustomModelGuardConfigurationIntervention(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action of the guard intervention.
        :param builtins.str condition: The JSON-encoded condition of the guard intervention. e.g. `{"comparand": 0.5, "comparator": "lessThan"}`
        :param builtins.str message: The message of the guard intervention.
        """
...
class CustomModelGuardConfigurationNemoInfo(dict):
    ...
    def __init__(__self__, *,
                 actions: Optional[builtins.str] = None,
                 blocked_terms: Optional[builtins.str] = None,
                 llm_prompts: Optional[builtins.str] = None,
                 main_config: Optional[builtins.str] = None,
                 rails_config: Optional[builtins.str] = None):
        """
        :param builtins.str actions: The actions for the NeMo information.
        :param builtins.str blocked_terms: NeMo guardrails blocked terms list.
        :param builtins.str llm_prompts: NeMo guardrails prompts.
        :param builtins.str main_config: Overall NeMo configuration YAML.
        :param builtins.str rails_config: NeMo guardrails configuration Colang.
        """
    ...
    @property
    @pulumi.getter
    def actions(self) -> Optional[builtins.str]:
        """
    ...
    def blocked_terms(self) -> Optional[builtins.str]:
        """
    ...
    def llm_prompts(self) -> Optional[builtins.str]:
        """
    ...
    def main_config(self) -> Optional[builtins.str]:
        """
    ...
    def rails_config(self) -> Optional[builtins.str]:
        """
...
class CustomModelOverallModerationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str timeout_action: The timeout action of the overall moderation configuration.
        :param builtins.int timeout_sec: The timeout in seconds of the overall moderation configuration.
        """
...
class CustomModelSourceRemoteRepository(dict):
    ...
    def __init__(__self__, *,
                 id: builtins.str,
                 ref: builtins.str,
                 source_paths: Sequence[builtins.str]):
        """
        :param builtins.str id: The ID of the source remote repository.
        :param builtins.str ref: The reference of the source remote repository.
        :param Sequence[builtins.str] source_paths: The list of source paths in the source remote repository.
        """
    ...
    def source_paths(self) -> Sequence[builtins.str]:
        """
...
class DatasourceParams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 catalog: Optional[builtins.str] = None,
                 fetch_size: Optional[builtins.int] = None,
                 partition_column: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 query: Optional[builtins.str] = None,
                 schema: Optional[builtins.str] = None,
                 table: Optional[builtins.str] = None):
        """
        :param builtins.str data_store_id: The id of the DataStore.
        :param builtins.str catalog: The Catalog name in the database if supported.
        :param builtins.int fetch_size: A user specified fetch size in the range [1, 20000]. By default a fetchSize will be assigned to balance throughput and memory usage.
        :param builtins.str partition_column: The name of the partition column.
        :param builtins.str path: The user-specified path for BLOB storage.
        :param builtins.str query: The user specified SQL query.
        :param builtins.str schema: The name of the schema associated with the table.
        :param builtins.str table: The name of specified database table.
        """
        pulumi.set(__self__, "data_store_id", data_store_id)
        if catalog is not None:
            pulumi.set(__self__, "catalog", catalog)
    ...
    def partition_column(self) -> Optional[builtins.str]:
        """
...
class DeploymentAssociationIdSettings(dict):
    ...
    def __init__(__self__, *,
                 auto_generate_id: Optional[builtins.bool] = None,
                 column_names: Optional[Sequence[builtins.str]] = None,
                 required_in_prediction_requests: Optional[builtins.bool] = None):
        """
        :param builtins.bool auto_generate_id: Whether to auto generate ID.
        :param Sequence[builtins.str] column_names: Name of the columns to be used as association ID, currently only support a list of one string.
        :param builtins.bool required_in_prediction_requests: Whether the association ID column is required in prediction requests.
        """
    ...
    def auto_generate_id(self) -> Optional[builtins.bool]:
        """
    ...
    def required_in_prediction_requests(self) -> Optional[builtins.bool]:
        """
...
class DeploymentBatchMonitoringSettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: If batch monitoring is enabled.
        """
...
class DeploymentBiasAndFairnessSettings(dict):
    ...
    def __init__(__self__, *,
                 fairness_metric_set: builtins.str,
                 fairness_threshold: builtins.float,
                 preferable_target_value: builtins.bool,
                 protected_features: Sequence[builtins.str]):
        """
        :param builtins.str fairness_metric_set: A set of fairness metrics to use for calculating fairness.
        :param builtins.float fairness_threshold: Threshold value of the fairness metric. Cannot be less than 0 or greater than 1.
        :param builtins.bool preferable_target_value: A target value that should be treated as a positive outcome for the prediction.
        :param Sequence[builtins.str] protected_features: A list of features to mark as protected.
        """
    ...
    def fairness_metric_set(self) -> builtins.str:
        """
    ...
    def fairness_threshold(self) -> builtins.float:
        """
    ...
    def preferable_target_value(self) -> builtins.bool:
        """
    ...
    def protected_features(self) -> Sequence[builtins.str]:
        """
...
class DeploymentChallengerModelsSettings(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool):
        """
        :param builtins.bool enabled: Is 'True' if challenger models is enabled for this deployment.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class DeploymentChallengerReplaySettings(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool):
        """
        :param builtins.bool enabled: If challenger replay is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class DeploymentDriftTrackingSettings(dict):
    ...
    def __init__(__self__, *,
                 feature_drift_enabled: Optional[builtins.bool] = None,
                 feature_selection: Optional[builtins.str] = None,
                 target_drift_enabled: Optional[builtins.bool] = None,
                 tracked_features: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool feature_drift_enabled: If feature drift tracking is to be turned on.
        :param builtins.str feature_selection: The feature selection method to be used for drift tracking.
        :param builtins.bool target_drift_enabled: If target drift tracking is to be turned on.
        :param Sequence[builtins.str] tracked_features: List of features to be tracked for drift.
        """
    ...
    def feature_drift_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def feature_selection(self) -> Optional[builtins.str]:
        """
    ...
    def target_drift_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def tracked_features(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DeploymentFeatureCacheSettings(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 fetching: Optional[builtins.bool] = None,
                 schedule: Optional['outputs.DeploymentFeatureCacheSettingsSchedule'] = None):
        """
        :param builtins.bool enabled: If feature cache is enabled for this Deployment.
        :param builtins.bool fetching: If feature cache fetching is enabled.
    ...
    @property
    @pulumi.getter
    def fetching(self) -> Optional[builtins.bool]:
        """
...
class DeploymentFeatureCacheSettingsSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 months: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] day_of_months: Days of the month.
        :param Sequence[builtins.str] day_of_weeks: Days of the week.
        :param Sequence[builtins.str] hours: Hours of the day.
        :param Sequence[builtins.str] minutes: Minutes of the day.
        :param Sequence[builtins.str] months: Months of the year.
        """
        pulumi.set(__self__, "day_of_months", day_of_months)
        pulumi.set(__self__, "day_of_weeks", day_of_weeks)
        pulumi.set(__self__, "hours", hours)
...
class DeploymentHealthSettingsAccuracy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failing_threshold: Optional[builtins.float] = None,
                 measurement: Optional[builtins.str] = None,
                 metric: Optional[builtins.str] = None,
                 warning_threshold: Optional[builtins.float] = None):
        """
        :param builtins.int batch_count: The batch count for the accuracy health settings.
        :param builtins.float failing_threshold: The failing threshold for the accuracy health settings.
        :param builtins.str measurement: The measurement for the accuracy health settings.
        :param builtins.str metric: The metric for the accuracy health settings.
        :param builtins.float warning_threshold: The warning threshold for the accuracy health settings.
        """
    ...
    def failing_threshold(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def measurement(self) -> Optional[builtins.str]:
        """
    ...
    def warning_threshold(self) -> Optional[builtins.float]:
        """
...
class DeploymentHealthSettingsActualsTimeliness(dict):
    ...
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 expected_frequency: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: If acutals timeliness is enabled for this Deployment.
        :param builtins.str expected_frequency: The expected frequency for the actuals timeliness health settings.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def expected_frequency(self) -> Optional[builtins.str]:
        """
...
class DeploymentHealthSettingsCustomMetricsFailingCondition(dict):
    ...
    def __init__(__self__, *,
                 compare_operator: builtins.str,
                 metric_id: builtins.str,
                 threshold: builtins.float):
        """
        :param builtins.str compare_operator: The compare operator for the failing condition of the custom metrics health settings.
        :param builtins.str metric_id: The metric ID for the failing condition of the custom metrics health settings.
        :param builtins.float threshold: The threshold for the failing condition of the custom metrics health settings.
        """
    ...
    def compare_operator(self) -> builtins.str:
        """
...
class DeploymentHealthSettingsCustomMetricsWarningCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 threshold: builtins.float):
        """
        :param builtins.str compare_operator: The compare operator for the warning condition of the custom metrics health settings.
        :param builtins.str metric_id: The metric ID for the warning condition of the custom metrics health settings.
        :param builtins.float threshold: The threshold for the warning condition of the custom metrics health settings.
        """
        pulumi.set(__self__, "compare_operator", compare_operator)
        pulumi.set(__self__, "metric_id", metric_id)
        pulumi.set(__self__, "threshold", threshold)
...
class DeploymentHealthSettingsDataDrift(dict):
    ...
    def __init__(__self__, *,
                 batch_count: Optional[builtins.int] = None,
                 drift_threshold: Optional[builtins.float] = None,
                 exclude_features: Optional[Sequence[builtins.str]] = None,
                 high_importance_failing_count: Optional[builtins.int] = None,
                 high_importance_warning_count: Optional[builtins.int] = None,
                 importance_threshold: Optional[builtins.float] = None,
                 low_importance_failing_count: Optional[builtins.int] = None,
                 low_importance_warning_count: Optional[builtins.int] = None,
                 starred_features: Optional[Sequence[builtins.str]] = None,
                 time_interval: Optional[builtins.str] = None):
        """
        :param builtins.int batch_count: The batch count for the data drift health settings.
        :param builtins.float drift_threshold: The drift threshold for the data drift health settings.
        :param Sequence[builtins.str] exclude_features: The exclude features for the data drift health settings.
        :param builtins.int high_importance_failing_count: The high importance failing count for the data drift health settings.
        :param builtins.int high_importance_warning_count: The high importance warning count for the data drift health settings.
        :param builtins.float importance_threshold: The importance threshold for the data drift health settings.
        :param builtins.int low_importance_failing_count: The low importance failing count for the data drift health settings.
        :param builtins.int low_importance_warning_count: The low importance warning count for the data drift health settings.
        :param Sequence[builtins.str] starred_features: The starred features for the data drift health settings.
        :param builtins.str time_interval: The time interval for the data drift health settings.
        """
        if batch_count is not None:
            pulumi.set(__self__, "batch_count", batch_count)
    ...
    def drift_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def exclude_features(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def high_importance_failing_count(self) -> Optional[builtins.int]:
        """
    ...
    def high_importance_warning_count(self) -> Optional[builtins.int]:
        """
    ...
    def importance_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def low_importance_failing_count(self) -> Optional[builtins.int]:
        """
    ...
    def low_importance_warning_count(self) -> Optional[builtins.int]:
        """
    ...
    def starred_features(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DeploymentHealthSettingsFairness(dict):
    ...
    def __init__(__self__, *,
                 protected_class_failing_count: Optional[builtins.int] = None,
                 protected_class_warning_count: Optional[builtins.int] = None):
        """
        :param builtins.int protected_class_failing_count: The protected class failing count for the fairness health settings.
        :param builtins.int protected_class_warning_count: The protected class warning count for the fairness health settings.
        """
    ...
    def protected_class_failing_count(self) -> Optional[builtins.int]:
        """
    ...
    def protected_class_warning_count(self) -> Optional[builtins.int]:
        """
...
class DeploymentHealthSettingsPredictionsTimeliness(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expected_frequency: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: If predictions timeliness is enabled for this Deployment.
        :param builtins.str expected_frequency: The expected frequency for the predictions timeliness health settings.
        """
        pulumi.set(__self__, "enabled", enabled)
        if expected_frequency is not None:
            pulumi.set(__self__, "expected_frequency", expected_frequency)
...
class DeploymentHealthSettingsService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int batch_count: The batch count for the service health settings.
        """
        pulumi.set(__self__, "batch_count", batch_count)
...
class DeploymentPredictionIntervalsSettings(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 percentiles: Optional[Sequence[builtins.int]] = None):
        """
        :param builtins.bool enabled: Whether prediction intervals are enabled for this deployment.
        :param Sequence[builtins.int] percentiles: List of enabled prediction intervals’ sizes for this deployment.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    @property
    @pulumi.getter
    def percentiles(self) -> Optional[Sequence[builtins.int]]:
        """
...
class DeploymentPredictionWarningSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: If target prediction warning is enabled for this Deployment.
...
class DeploymentPredictionWarningSettingsCustomBoundaries(dict):
    ...
    def __init__(__self__, *,
                 lower_boundary: Optional[builtins.float] = None,
                 upper_boundary: Optional[builtins.float] = None):
        """
        :param builtins.float lower_boundary: All predictions less than provided value will be considered anomalous.
        :param builtins.float upper_boundary: All predictions greater than provided value will be considered anomalous.
        """
    ...
    def lower_boundary(self) -> Optional[builtins.float]:
        """
    ...
    def upper_boundary(self) -> Optional[builtins.float]:
        """
...
class DeploymentPredictionsByForecastDateSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Is ’True’ if predictions by forecast date is enabled for this deployment.
        :param builtins.str column_name: The column name in prediction datasets to be used as forecast date.
        :param builtins.str datetime_format: The datetime format of the forecast date column in prediction datasets.
        """
        pulumi.set(__self__, "enabled", enabled)
        if column_name is not None:
            pulumi.set(__self__, "column_name", column_name)
...
class DeploymentPredictionsDataCollectionSettings(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool):
        """
        :param builtins.bool enabled: If predictions data collections is enabled for this Deployment.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class DeploymentPredictionsSettings(dict):
    ...
    def __init__(__self__, *,
                 max_computes: Optional[builtins.int] = None,
                 min_computes: Optional[builtins.int] = None,
                 resource_bundle_id: Optional[builtins.str] = None):
        """
        :param builtins.int max_computes: The maximum number of computes to use for predictions.
        :param builtins.int min_computes: The minimum number of computes to use for predictions.
        :param builtins.str resource_bundle_id: The resource bundle ID to use for predictions.
        """
    ...
    def max_computes(self) -> Optional[builtins.int]:
        """
    ...
    def min_computes(self) -> Optional[builtins.int]:
        """
    ...
    def resource_bundle_id(self) -> Optional[builtins.str]:
        """
...
class DeploymentRetrainingPolicyAutopilotOptions(dict):
    ...
    def __init__(__self__, *,
                 blend_best_models: Optional[builtins.bool] = None,
                 mode: Optional[builtins.str] = None,
                 run_leakage_removed_feature_list: Optional[builtins.bool] = None,
                 scoring_code_only: Optional[builtins.bool] = None,
                 shap_only_mode: Optional[builtins.bool] = None):
        """
        :param builtins.bool blend_best_models: Blend best models during Autopilot run. This option is not supported in SHAP-only mode.
        :param builtins.str mode: The autopiltot mode.
        :param builtins.bool run_leakage_removed_feature_list: Run Autopilot on Leakage Removed feature list (if exists).
        :param builtins.bool scoring_code_only: Keep only models that can be converted to scorable java code during Autopilot run.
        :param builtins.bool shap_only_mode: Include only models with SHAP value support.
        """
    ...
    def blend_best_models(self) -> Optional[builtins.bool]:
        """
    ...
    def run_leakage_removed_feature_list(self) -> Optional[builtins.bool]:
        """
    ...
    def scoring_code_only(self) -> Optional[builtins.bool]:
        """
    ...
    def shap_only_mode(self) -> Optional[builtins.bool]:
        """
...
class DeploymentRetrainingPolicyProjectOptions(dict):
    ...
    def __init__(__self__, *,
                 cv_method: Optional[builtins.str] = None,
                 holdout_pct: Optional[builtins.float] = None,
                 metric: Optional[builtins.str] = None,
                 reps: Optional[builtins.float] = None,
                 validation_pct: Optional[builtins.float] = None,
                 validation_type: Optional[builtins.str] = None):
        """
        :param builtins.str cv_method: The partitioning method for projects used to build new models.
        :param builtins.float holdout_pct: The percentage of dataset to assign to holdout set in projects used to build new models.
        :param builtins.str metric: The model selection metric in projects used to build new models.
        :param builtins.float reps: The number of cross validation folds to use for projects used to build new models.
        :param builtins.float validation_pct: The percentage of dataset to assign to validation set in projects used to build new models.
        :param builtins.str validation_type: The validation type for projects used to build new models.
        """
    ...
    def cv_method(self) -> Optional[builtins.str]:
        """
    ...
    def holdout_pct(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def reps(self) -> Optional[builtins.float]:
        """
    ...
    def validation_pct(self) -> Optional[builtins.float]:
        """
...
class DeploymentRetrainingPolicyTimeSeriesOptions(dict):
    ...
    def __init__(__self__, *,
                 calendar_id: Optional[builtins.str] = None,
                 differencing_method: Optional[builtins.str] = None,
                 exponentially_weighted_moving_alpha: Optional[builtins.float] = None,
                 periodicities: Optional[Sequence['outputs.DeploymentRetrainingPolicyTimeSeriesOptionsPeriodicity']] = None,
                 treat_as_exponential: Optional[builtins.str] = None):
        """
        :param builtins.str calendar_id: The ID of the calendar to be used in this project.
        :param builtins.str differencing_method: For time series projects only. Used to specify which differencing method to apply if the data is stationary. For classification problems simple and seasonal are not allowed. Parameter periodicities must be specified if seasonal is chosen. Defaults to auto.
        :param builtins.float exponentially_weighted_moving_alpha: Discount factor (alpha) used for exponentially weighted moving features.
        ...
        :param builtins.str treat_as_exponential: For time series projects only. Used to specify whether to treat data as exponential trend and apply transformations like log-transform. For classification problems always is not allowed. Defaults to auto.
        """
    ...
    def calendar_id(self) -> Optional[builtins.str]:
        """
    ...
    def differencing_method(self) -> Optional[builtins.str]:
        """
    ...
    def exponentially_weighted_moving_alpha(self) -> Optional[builtins.float]:
        """
    ...
    def treat_as_exponential(self) -> Optional[builtins.str]:
        """
...
class DeploymentRetrainingPolicyTimeSeriesOptionsPeriodicity(dict):
    ...
    def __init__(__self__, *,
                 time_steps: builtins.int,
                 time_unit: builtins.str):
        """
        :param builtins.int time_steps: The number of time steps.
        :param builtins.str time_unit: The time unit or ROW if windowsBasisUnit is ROW
        """
    ...
    def time_steps(self) -> builtins.int:
        """
...
class DeploymentRetrainingPolicyTrigger(dict):
    ...
    def __init__(__self__, *,
                 custom_job_id: Optional[builtins.str] = None,
                 min_interval_between_runs: Optional[builtins.str] = None,
                 schedule: Optional['outputs.DeploymentRetrainingPolicyTriggerSchedule'] = None,
                 status_declines_to_failing: Optional[builtins.bool] = None,
                 status_declines_to_warning: Optional[builtins.bool] = None,
                 status_still_in_decline: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str custom_job_id: Custom job ID for the retraining policy.
        :param builtins.str min_interval_between_runs: Minimal interval between policy runs in ISO 8601 duration string.
        :param 'DeploymentRetrainingPolicyTriggerScheduleArgs' schedule: Schedule for the retraining policy.
        :param builtins.bool status_declines_to_failing: Identifies when trigger type is based on deployment a health status, whether the policy will run when health status declines to failing.
        :param builtins.bool status_declines_to_warning: Identifies when trigger type is based on deployment a health status, whether the policy will run when health status declines to warning.
        :param builtins.bool status_still_in_decline: Identifies when trigger type is based on deployment a health status, whether the policy will run when health status still in decline.
        :param builtins.str type: Type of retraining policy trigger.
        """
    ...
    def custom_job_id(self) -> Optional[builtins.str]:
        """
    ...
    def min_interval_between_runs(self) -> Optional[builtins.str]:
        """
    ...
    def status_declines_to_failing(self) -> Optional[builtins.bool]:
        """
    ...
    def status_declines_to_warning(self) -> Optional[builtins.bool]:
        """
    ...
    def status_still_in_decline(self) -> Optional[builtins.bool]:
        """
...
class DeploymentRetrainingSettings(dict):
    ...
    def __init__(__self__, *,
                 credential_id: Optional[builtins.str] = None,
                 dataset_id: Optional[builtins.str] = None,
                 prediction_environment_id: Optional[builtins.str] = None,
                 retraining_user_id: Optional[builtins.str] = None):
        """
        :param builtins.str credential_id: ID of the credential used to refresh retraining dataset.
        :param builtins.str dataset_id: ID of the retraining dataset.
        :param builtins.str prediction_environment_id: ID of the prediction environment to associate with the challengers created by retraining policies.
        :param builtins.str retraining_user_id: ID of the retraining user.
        """
        if credential_id is not None:
            pulumi.set(__self__, "credential_id", credential_id)
        if dataset_id is not None:
    ...
    def prediction_environment_id(self) -> Optional[builtins.str]:
        """
    ...
    def retraining_user_id(self) -> Optional[builtins.str]:
        """
...
class DeploymentSegmentAnalysisSettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Set to 'True' if segment analysis is enabled for this deployment.
        :param Sequence[builtins.str] attributes: A list of strings that gives the segment attributes selected for tracking.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class LlmBlueprintCustomModelLlmSettings(dict):
    ...
    def __init__(__self__, *,
                 external_llm_context_size: Optional[builtins.int] = None,
                 system_prompt: Optional[builtins.str] = None,
                 validation_id: Optional[builtins.str] = None):
        """
        :param builtins.int external_llm_context_size: The external LLM's context size, in tokens. This value is only used for pruning documents supplied to the LLM when a vector database is associated with the LLM blueprint. It does not affect the external LLM's actual context size in any way and is not supplied to the LLM.
        :param builtins.str system_prompt: System prompt guides the style of the LLM response. It is a 'universal' prompt, prepended to all individual prompts.
        :param builtins.str validation_id: The validation ID of the custom model LLM.
        """
    ...
    def external_llm_context_size(self) -> Optional[builtins.int]:
        """
    ...
    def system_prompt(self) -> Optional[builtins.str]:
        """
    ...
    def validation_id(self) -> Optional[builtins.str]:
        """
...
class LlmBlueprintVectorDatabaseSettings(dict):
    ...
    def __init__(__self__, *,
                 max_documents_retrieved_per_prompt: Optional[builtins.int] = None,
                 max_tokens: Optional[builtins.int] = None):
        """
        :param builtins.int max_documents_retrieved_per_prompt: The maximum number of documents to retrieve from the Vector Database.
        :param builtins.int max_tokens: The maximum number of tokens to retrieve from the Vector Database.
        """
    ...
    def max_documents_retrieved_per_prompt(self) -> Optional[builtins.int]:
        """
...
class NotificationChannelDrEntity(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str id: The ID of the DataRobot entity.
        :param builtins.str name: The name of the entity.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class VectorDatabaseChunkingParameters(dict):
    ...
    def chunk_overlap_percentage(self) -> Optional[builtins.int]:
        """
    ...
    def chunking_method(self) -> Optional[builtins.str]:
        """
    ...
    def is_separator_regex(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def separators(self) -> Optional[Sequence[builtins.str]]:
        """
...
class WorkloadRuntimeContainerGroupAutoscaling(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_replica_count: Maximum number of replicas. Defaults to `1`.
        :param builtins.int min_replica_count: Minimum number of replicas. Set to `0` to allow scale-to-zero. Defaults to `0`.
        """
...
class WorkloadRuntimeContainerGroupAutoscalingPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str scaling_metric: Metric used for scaling decisions: `cpuAverageUtilization`, `httpRequestsConcurrency`, `gpuCacheUtilization`, or `gpuRequestQueueDepth`. Custom metric names (e.g. `vllm:kv_cache_usage_perc`) are supported for NIM artifacts only.
        :param builtins.float target: Target value for the scaling metric. Must be non-negative.
        """
...
class WorkloadRuntimeReplacementPolicy(dict):
    ...
    def __init__(__self__, *,
                 keep_old_version_minutes: Optional[builtins.int] = None,
                 warmup_minutes: Optional[builtins.int] = None):
        """
        :param builtins.int keep_old_version_minutes: Duration in minutes to keep the old version during replacement. Maps to WAPI `config.keepOldVersionMinutes`.
        :param builtins.int warmup_minutes: Duration in minutes for the warmup phase during replacement. Maps to WAPI `config.warmupDurationMinutes`.
        """
    ...
    def keep_old_version_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def warmup_minutes(self) -> Optional[builtins.int]:
        """
...
class GetArtifactSpecContainerGroupContainerEnvironmentVarResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name of the environment variable. May be absent for "api-key" entries, in which case the token is injected as DATAROBOT*API*TOKEN.
        :param builtins.str source: Source type: "string" for plain text values, "dr-credential" for DataRobot credentials, "api-key" for a platform-managed DataRobot API token.
