...
class ArtifactSpecContainerGroupContainerEnvironmentVar(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str credential_id: DataRobot credential ID. Required when source is "dr-credential".
        :param _builtins.str key: Key within the credential. Required when source is "dr-credential".
        :param _builtins.str source: Source type: "string" for plain text values, "dr-credential" for DataRobot credentials. Defaults to "string".
...
class WorkloadRuntimeContainerGroupAutoscalingPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int max_count: Maximum number of replicas.
        :param _builtins.int min_count: Minimum number of replicas.
        :param _builtins.str scaling_metric: Metric used for scaling decisions: `cpuAverageUtilization`, `httpRequestsConcurrency`, `gpuCacheUtilization`, or `gpuRequestQueueDepth`.
        :param _builtins.float target: Target value for the scaling metric.
        :param _builtins.int priority: Policy priority when multiple policies are defined.
        """
...
class WorkloadRuntimeContainerGroupContainerResourceAllocation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gpu_memory: Optional[_builtins.int] = None,
        ...
        :param _builtins.int gpu_memory: GPU VRAM allocated in bytes.
        :param _builtins.int memory: RAM allocated in bytes.
        """
        if cpu is not None:
    ...
    def gpu_memory(self) -> Optional[_builtins.int]:
        """
