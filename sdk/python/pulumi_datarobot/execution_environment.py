...
class ExecutionEnvironmentArgs:
    def __init__(__self__, *,
                 programming_language: pulumi.Input[_builtins.str],
                 ...
                 docker_image_uri: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] programming_language: The programming language of the Execution Environment.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] use_cases: The list of Use Cases that the Execution Environment supports.
        :param pulumi.Input[_builtins.str] description: The description of the Execution Environment.
        :param pulumi.Input[_builtins.str] docker_context_path: The path to a docker context archive or folder
        :param pulumi.Input[_builtins.str] docker_image: A prebuilt environment image saved as a tarball using the Docker save command.
        :param pulumi.Input[_builtins.str] docker_image_uri: The URI of a pre-built environment image (e.g., in a remote Docker registry).
        :param pulumi.Input[_builtins.str] name: The name of the Execution Environment.
        :param pulumi.Input[_builtins.str] version_description: The description of the Execution Environment version.
        """
    ...
    def programming_language(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def programming_language(self, value: pulumi.Input[_builtins.str]):
    ...
    def docker_image_uri(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def docker_image_uri(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _ExecutionEnvironmentState:
    def __init__(__self__, *,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 docker_context_hash: pulumi.Input[Optional[_builtins.str]] = None,
                 docker_context_path: pulumi.Input[Optional[_builtins.str]] = None,
                 docker_image: pulumi.Input[Optional[_builtins.str]] = None,
                 docker_image_hash: pulumi.Input[Optional[_builtins.str]] = None,
                 docker_image_uri: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] build_status: The status of the Execution Environment version build.
        :param pulumi.Input[_builtins.str] description: The description of the Execution Environment.
        :param pulumi.Input[_builtins.str] docker_context_hash: The hash of the docker context contents.
        :param pulumi.Input[_builtins.str] docker_context_path: The path to a docker context archive or folder
        :param pulumi.Input[_builtins.str] docker_image: A prebuilt environment image saved as a tarball using the Docker save command.
        :param pulumi.Input[_builtins.str] docker_image_hash: The hash of the docker image file
        :param pulumi.Input[_builtins.str] docker_image_uri: The URI of a pre-built environment image (e.g., in a remote Docker registry).
        :param pulumi.Input[_builtins.str] name: The name of the Execution Environment.
        :param pulumi.Input[_builtins.str] programming_language: The programming language of the Execution Environment.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] use_cases: The list of Use Cases that the Execution Environment supports.
        :param pulumi.Input[_builtins.str] version_description: The description of the Execution Environment version.
        :param pulumi.Input[_builtins.str] version_id: The ID of the Execution Environment Version.
        """
    ...
    def docker_context_hash(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def docker_context_hash(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def docker_image_hash(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def docker_image_hash(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ExecutionEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            use_cases: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            version_description: pulumi.Input[Optional[_builtins.str]] = None,
            version_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ExecutionEnvironment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dockerContextHash")
    def docker_context_hash(self) -> pulumi.Output[_builtins.str]:
        """
        The hash of the docker context contents.
        """
        return pulumi.get(self, "docker_context_hash")
    ...
    @_builtins.property
    @pulumi.getter(name="dockerContextPath")
    def docker_context_path(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The path to a docker context archive or folder
        """
        return pulumi.get(self, "docker_context_path")
    ...
    @_builtins.property
    @pulumi.getter(name="dockerImage")
    def docker_image(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A prebuilt environment image saved as a tarball using the Docker save command.
        """
        return pulumi.get(self, "docker_image")
    ...
    @_builtins.property
    @pulumi.getter(name="dockerImageHash")
    def docker_image_hash(self) -> pulumi.Output[_builtins.str]:
        """
        The hash of the docker image file
        """
        return pulumi.get(self, "docker_image_hash")
    ...
    @_builtins.property
    @pulumi.getter(name="dockerImageUri")
    def docker_image_uri(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The URI of a pre-built environment image (e.g., in a remote Docker registry).
        """
        return pulumi.get(self, "docker_image_uri")
