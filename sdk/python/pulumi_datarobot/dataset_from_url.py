...
class DatasetFromUrlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] url: The URL to upload the Dataset from.
...
class DatasetFromUrl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            url: pulumi.Input[Optional[_builtins.str]] = None,
            use_case_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'DatasetFromUrl':
        """
