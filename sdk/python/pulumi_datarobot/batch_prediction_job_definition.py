...
class BatchPredictionJobDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 csv_settings: pulumi.Input[Optional['BatchPredictionJobDefinitionCsvSettingsArgs']] = None,
                 ...
                 output_settings: pulumi.Input[Optional['BatchPredictionJobDefinitionOutputSettingsArgs']] = None,
                 ...
                 prediction_instance: pulumi.Input[Optional['BatchPredictionJobDefinitionPredictionInstanceArgs']] = None,
                 ...
                 schedule: pulumi.Input[Optional['BatchPredictionJobDefinitionScheduleArgs']] = None,
                 ...
                 timeseries_settings: pulumi.Input[Optional['BatchPredictionJobDefinitionTimeseriesSettingsArgs']] = None):
        """
    ...
    def abort_on_error(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def abort_on_error(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def column_names_remapping(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
    ...
    def column_names_remapping(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "column_names_remapping", value)

    @_builtins.property
    @pulumi.getter(name="csvSettings")
    def csv_settings(self) -> pulumi.Input[Optional['BatchPredictionJobDefinitionCsvSettingsArgs']]:
        """
    ...
    @csv_settings.setter
    def csv_settings(self, value: pulumi.Input[Optional['BatchPredictionJobDefinitionCsvSettingsArgs']]):
    ...
    def explanation_algorithm(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def explanation_algorithm(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "explanation_algorithm", value)

    @_builtins.property
    @pulumi.getter(name="includePredictionStatus")
    def include_prediction_status(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Include the<span pulumi-lang-nodejs=" predictionStatus " pulumi-lang-dotnet=" PredictionStatus " pulumi-lang-go=" predictionStatus " pulumi-lang-python=" prediction_status " pulumi-lang-yaml=" predictionStatus " pulumi-lang-java=" predictionStatus " pulumi-lang-hcl=" prediction_status "> predictionStatus </span>column in the output. Defaults to False.
        """
    ...
    def include_prediction_status(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "include_prediction_status", value)

    @_builtins.property
    @pulumi.getter(name="includeProbabilities")
    def include_probabilities(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def include_probabilities(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "include_probabilities", value)

    @_builtins.property
    @pulumi.getter(name="includeProbabilitiesClasses")
    def include_probabilities_classes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def include_probabilities_classes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "include_probabilities_classes", value)

    @_builtins.property
    @pulumi.getter(name="maxExplanations")
    def max_explanations(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def max_explanations(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def num_concurrent(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def num_concurrent(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "num_concurrent", value)

    @_builtins.property
    @pulumi.getter(name="outputSettings")
    def output_settings(self) -> pulumi.Input[Optional['BatchPredictionJobDefinitionOutputSettingsArgs']]:
        """
    ...
    def output_settings(self, value: pulumi.Input[Optional['BatchPredictionJobDefinitionOutputSettingsArgs']]):
        pulumi.set(self, "output_settings", value)

    @_builtins.property
    @pulumi.getter(name="passthroughColumns")
    def passthrough_columns(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def passthrough_columns(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "passthrough_columns", value)

    @_builtins.property
    @pulumi.getter(name="passthroughColumnsSet")
    def passthrough_columns_set(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def passthrough_columns_set(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "passthrough_columns_set", value)

    @_builtins.property
    @pulumi.getter(name="predictionInstance")
    def prediction_instance(self) -> pulumi.Input[Optional['BatchPredictionJobDefinitionPredictionInstanceArgs']]:
        """
    ...
    def prediction_instance(self, value: pulumi.Input[Optional['BatchPredictionJobDefinitionPredictionInstanceArgs']]):
    ...
    def prediction_warning_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def prediction_warning_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "prediction_warning_enabled", value)

    @_builtins.property
    @pulumi.getter
    def schedule(self) -> pulumi.Input[Optional['BatchPredictionJobDefinitionScheduleArgs']]:
        """
    ...
    @schedule.setter
    def schedule(self, value: pulumi.Input[Optional['BatchPredictionJobDefinitionScheduleArgs']]):
        pulumi.set(self, "schedule", value)

    @_builtins.property
    @pulumi.getter(name="skipDriftTracking")
    def skip_drift_tracking(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def skip_drift_tracking(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "skip_drift_tracking", value)

    @_builtins.property
    @pulumi.getter(name="thresholdHigh")
    def threshold_high(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def threshold_high(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "threshold_high", value)

    @_builtins.property
    @pulumi.getter(name="thresholdLow")
    def threshold_low(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def threshold_low(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "threshold_low", value)

    @_builtins.property
    @pulumi.getter(name="timeseriesSettings")
    def timeseries_settings(self) -> pulumi.Input[Optional['BatchPredictionJobDefinitionTimeseriesSettingsArgs']]:
        """
    ...
    def timeseries_settings(self, value: pulumi.Input[Optional['BatchPredictionJobDefinitionTimeseriesSettingsArgs']]):
...
class _BatchPredictionJobDefinitionState:
    def __init__(__self__, *,
                 ...
                 include_probabilities: pulumi.Input[Optional[_builtins.bool]] = None,
                 include_probabilities_classes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 intake_settings: pulumi.Input[Optional['BatchPredictionJobDefinitionIntakeSettingsArgs']] = None,
                 max_explanations: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 num_concurrent: pulumi.Input[Optional[_builtins.int]] = None,
                 output_settings: pulumi.Input[Optional['BatchPredictionJobDefinitionOutputSettingsArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="intakeSettings")
    def intake_settings(self) -> pulumi.Input[Optional['BatchPredictionJobDefinitionIntakeSettingsArgs']]:
        """
        A dict configuring how data is coming from.
        """
        return pulumi.get(self, "intake_settings")
    ...
    @intake_settings.setter
    def intake_settings(self, value: pulumi.Input[Optional['BatchPredictionJobDefinitionIntakeSettingsArgs']]):
        pulumi.set(self, "intake_settings", value)
...
class BatchPredictionJobDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        batch_prediction_job_definition = datarobot.CustomModel("batch_prediction_job_definition",
            name="Example Custom Model",
            target_type="Binary",
            target_name="my_label",
            base_environment_id="65f9b27eab986d30d4c64268",
            files=["example.py"])
        batch_prediction_job_definition_registered_model = datarobot.RegisteredModel("batch_prediction_job_definition",
            custom_model_version_id=batch_prediction_job_definition.version_id,
            name="Example Registered Model")
        batch_prediction_job_definition_prediction_environment = datarobot.PredictionEnvironment("batch_prediction_job_definition",
            name="Example Prediction Environment",
            platform="datarobotServerless")
        batch_prediction_job_definition_deployment = datarobot.Deployment("batch_prediction_job_definition",
            label="An example deployment",
            prediction_environment_id=batch_prediction_job_definition_prediction_environment.id,
            registered_model_version_id=batch_prediction_job_definition_registered_model.version_id)
        batch_prediction_job_definition_basic_credential = datarobot.BasicCredential("batch_prediction_job_definition",
            name="Example Basic Credential",
            user="example_user",
            password="example_password")
        example = datarobot.BatchPredictionJobDefinition("example",
            name="Example Batch Prediction Job Definition",
            deployment_id=batch_prediction_job_definition_deployment.id,
            intake_settings={
                "type": "s3",
                "url": "s3://datarobot-public-datasets-redistributable/1k_diabetes_simplified_features.csv",
                "credential_id": batch_prediction_job_definition_basic_credential.id,
            },
            output_settings={
                "type": "s3",
    ...
    @_builtins.property
    @pulumi.getter(name="abortOnError")
    def abort_on_error(self) -> pulumi.Output[_builtins.bool]:
        """
        Default behavior is to abort the job if too many rows fail scoring. This will free up resources for other jobs that may score successfully. Set to false to unconditionally score every row no matter how many errors are encountered. Defaults to True.
        """
        return pulumi.get(self, "abort_on_error")
    ...
    @_builtins.property
    @pulumi.getter(name="columnNamesRemapping")
    def column_names_remapping(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        Mapping with column renaming for output table.
        """
        return pulumi.get(self, "column_names_remapping")
    ...
    @_builtins.property
    @pulumi.getter(name="explanationAlgorithm")
    def explanation_algorithm(self) -> pulumi.Output[_builtins.str]:
        """
        Which algorithm will be used to calculate prediction explanations.
        """
        return pulumi.get(self, "explanation_algorithm")
    ...
    @_builtins.property
    @pulumi.getter(name="includePredictionStatus")
    def include_prediction_status(self) -> pulumi.Output[_builtins.bool]:
        """
        Include the<span pulumi-lang-nodejs=" predictionStatus " pulumi-lang-dotnet=" PredictionStatus " pulumi-lang-go=" predictionStatus " pulumi-lang-python=" prediction_status " pulumi-lang-yaml=" predictionStatus " pulumi-lang-java=" predictionStatus " pulumi-lang-hcl=" prediction_status "> predictionStatus </span>column in the output. Defaults to False.
        """
        return pulumi.get(self, "include_prediction_status")
    ...
    @_builtins.property
    @pulumi.getter(name="includeProbabilities")
    def include_probabilities(self) -> pulumi.Output[_builtins.bool]:
        """
        Flag that enables returning of all probability columns. Defaults to True.
        """
        return pulumi.get(self, "include_probabilities")
    ...
    @_builtins.property
    @pulumi.getter(name="includeProbabilitiesClasses")
    def include_probabilities_classes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List the subset of classes if a user doesn’t want all the classes. Defaults to [].
        """
        return pulumi.get(self, "include_probabilities_classes")
    ...
    @_builtins.property
    @pulumi.getter(name="maxExplanations")
    def max_explanations(self) -> pulumi.Output[_builtins.int]:
        """
        Compute prediction explanations for this amount of features.
        """
        return pulumi.get(self, "max_explanations")
    ...
    @_builtins.property
    @pulumi.getter(name="numConcurrent")
    def num_concurrent(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Number of concurrent chunks to score simultaneously. Defaults to the available number of cores of the deployment. Lower it to leave resources for real-time scoring.
        """
        return pulumi.get(self, "num_concurrent")
    ...
    @_builtins.property
    @pulumi.getter(name="passthroughColumns")
    def passthrough_columns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Keep these columns from the scoring dataset in the scored dataset. This is useful for correlating predictions with source data.
        """
        return pulumi.get(self, "passthrough_columns")
    ...
    @_builtins.property
    @pulumi.getter(name="passthroughColumnsSet")
    def passthrough_columns_set(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        To pass through every column from the scoring dataset, set this to all.
        """
        return pulumi.get(self, "passthrough_columns_set")
    ...
    @_builtins.property
    @pulumi.getter(name="predictionThreshold")
    def prediction_threshold(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Threshold is the point that sets the class boundary for a predicted value. This value can be set between 0.0 and 1.0.
        """
        return pulumi.get(self, "prediction_threshold")
    ...
    @_builtins.property
    @pulumi.getter(name="predictionWarningEnabled")
    def prediction_warning_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Add prediction warnings to the scored data. Currently only supported for regression models. Defaults to False.
        """
        return pulumi.get(self, "prediction_warning_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="skipDriftTracking")
    def skip_drift_tracking(self) -> pulumi.Output[_builtins.bool]:
        """
        Skips drift tracking on any predictions made from this job. This is useful when running non-production workloads to not affect drift tracking and cause unnecessary alerts. Defaults to false.
        """
        return pulumi.get(self, "skip_drift_tracking")
    ...
    @_builtins.property
    @pulumi.getter(name="thresholdHigh")
    def threshold_high(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Only compute prediction explanations for predictions above this threshold. Can be combined with threshold_low.
        """
        return pulumi.get(self, "threshold_high")
    ...
    @_builtins.property
    @pulumi.getter(name="thresholdLow")
    def threshold_low(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Only compute prediction explanations for predictions below this threshold. Can be combined with threshold_high.
        """
        return pulumi.get(self, "threshold_low")
