...
class DeploymentRetrainingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = datarobot.DeploymentRetrainingPolicy("example",
            ...
            trigger={
                "custom_job_id": example_datarobot_custom_job["id"],
            },
            autopilot_options={},
            project_options={},
            time_series_options={},
            use_case_id=example_datarobot_use_case["id"])
        pulumi.export("datarobotDeploymentRetrainingPolicyId", example.id)
        ```
