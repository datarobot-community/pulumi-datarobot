...
class AwsCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] config_id: The ID of the saved shared secure configuration. If specified, cannot include awsAccessKeyId, awsSecretAccessKey or awsSessionToken.
        :param pulumi.Input[_builtins.str] description: The description of the AWS Credential.
        :param pulumi.Input[_builtins.str] name: The name of the AWS Credential.
        """
...
class AwsCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: pulumi.Input[Optional[_builtins.str]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None) -> 'AwsCredential':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="configId")
    def config_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the saved shared secure configuration. If specified, cannot include awsAccessKeyId, awsSecretAccessKey or awsSessionToken.
        """
        return pulumi.get(self, "config_id")
