...
class AzureCredentialArgs:
    def __init__(__self__, *,
                 azure_connection_string: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AzureCredential resource.
        :param pulumi.Input[builtins.str] azure_connection_string: The connection string of the Azure Credential.
        :param pulumi.Input[builtins.str] description: The description of the Azure Credential.
    ...
    def azure_connection_string(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def azure_connection_string(self, value: pulumi.Input[builtins.str]):
...
class _AzureCredentialState:
    def __init__(__self__, *,
                 azure_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="azureConnectionString")
    def azure_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The connection string of the Azure Credential.
        """
        return pulumi.get(self, "azure_connection_string")
    ...
    @azure_connection_string.setter
    def azure_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "azure_connection_string", value)
...
class AzureCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            azure_connection_string: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'AzureCredential':
        """
    ...
    @property
    @pulumi.getter(name="azureConnectionString")
    def azure_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        The connection string of the Azure Credential.
        """
        return pulumi.get(self, "azure_connection_string")
