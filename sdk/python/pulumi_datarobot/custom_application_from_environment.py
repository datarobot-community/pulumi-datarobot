...
class CustomApplicationFromEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 resources: pulumi.Input[Optional['CustomApplicationFromEnvironmentResourcesArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] environment_id: The ID of the Execution Environment used to create the Custom Application.
        :param pulumi.Input[_builtins.bool] allow_auto_stopping: Whether auto stopping is allowed for the Custom Application.
        :param pulumi.Input[_builtins.bool] external_access_enabled: Whether external access is enabled for the Custom Application.
        ...
        :param pulumi.Input['CustomApplicationFromEnvironmentResourcesArgs'] resources: The resources for the Custom Application. If not specified, default values will be computed by the API based on the cluster configuration.
    ...
    @_builtins.property
    @pulumi.getter
    def resources(self) -> pulumi.Input[Optional['CustomApplicationFromEnvironmentResourcesArgs']]:
        """
    ...
    @resources.setter
    def resources(self, value: pulumi.Input[Optional['CustomApplicationFromEnvironmentResourcesArgs']]):
...
class _CustomApplicationFromEnvironmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_auto_stopping: Whether auto stopping is allowed for the Custom Application.
        :param pulumi.Input[_builtins.str] application_url: The URL of the Custom Application.
        :param pulumi.Input[_builtins.str] environment_id: The ID of the Execution Environment used to create the Custom Application.
        :param pulumi.Input[_builtins.str] environment_version_id: The version ID of the Execution Environment used to create the Custom Application.
        :param pulumi.Input[_builtins.bool] external_access_enabled: Whether external access is enabled for the Custom Application.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] external_access_recipients: The list of external email addresses that have access to the Custom Application.
        :param pulumi.Input[_builtins.str] name: The name of the Custom Application.
        :param pulumi.Input['CustomApplicationFromEnvironmentResourcesArgs'] resources: The resources for the Custom Application. If not specified, default values will be computed by the API based on the cluster configuration.
...
class CustomApplicationFromEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 external_access_recipients: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 resources: pulumi.Input[Optional[Union['CustomApplicationFromEnvironmentResourcesArgs', 'CustomApplicationFromEnvironmentResourcesArgsDict']]] = None,
                 use_case_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        example = datarobot.CustomApplicationFromEnvironment("example",
            ...
            environment_id=example_datarobot_execution_environment["id"],
        ...
        pulumi.export("datarobotCustomApplicationResources", example.resources)
        ```
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] external_access_recipients: The list of external email addresses that have access to the Custom Application.
        :param pulumi.Input[_builtins.str] name: The name of the Custom Application.
        :param pulumi.Input[Union['CustomApplicationFromEnvironmentResourcesArgs', 'CustomApplicationFromEnvironmentResourcesArgsDict']] resources: The resources for the Custom Application. If not specified, default values will be computed by the API based on the cluster configuration.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] use_case_ids: The list of Use Case IDs to add the Custom Application to.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            resources: pulumi.Input[Optional[Union['CustomApplicationFromEnvironmentResourcesArgs', 'CustomApplicationFromEnvironmentResourcesArgsDict']]] = None,
            use_case_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'CustomApplicationFromEnvironment':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def resources(self) -> pulumi.Output['outputs.CustomApplicationFromEnvironmentResources']:
        """
        The resources for the Custom Application. If not specified, default values will be computed by the API based on the cluster configuration.
        """
        return pulumi.get(self, "resources")
