...
class DatasetFromDatasourceArgs:
    def __init__(__self__, *,
                 ...
                 do_snapshot: pulumi.Input[Optional[_builtins.bool]] = None,
                 persist_data_after_ingestion: pulumi.Input[Optional[_builtins.bool]] = None,
                 sample_size_rows: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] credential_id: The ID of the set of credentials to use.
        :param pulumi.Input[_builtins.str] data_source_id: The ID for the DataSource to use as the source of data.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] categories: An array of strings describing the intended use of the dataset.
        :param pulumi.Input[_builtins.bool] do_snapshot: If unset, uses the server default: True. If true, creates a snapshot dataset; if false, creates a remote dataset.
        :param pulumi.Input[_builtins.bool] persist_data_after_ingestion: If unset, uses the server default: True. If true, will enforce saving all data (for download and sampling) and will allow a user to view extended data profile (which includes data statistics like min/max/median/mean, histogram, etc.). If false, will not enforce saving data. The data schema (feature names and types) still will be available.
        :param pulumi.Input[_builtins.int] sample_size_rows: The number of rows fetched during dataset registration.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] use_case_ids: The list of Use Case IDs to add the Dataset to.
        :param pulumi.Input[_builtins.bool] use_kerberos: If unset, uses the server default: False. If true, use kerberos authentication for database authentication.
        """
    ...
    def do_snapshot(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    @do_snapshot.setter
    def do_snapshot(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "do_snapshot", value)

    @_builtins.property
    @pulumi.getter(name="persistDataAfterIngestion")
    def persist_data_after_ingestion(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def persist_data_after_ingestion(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "persist_data_after_ingestion", value)

    @_builtins.property
    @pulumi.getter(name="sampleSizeRows")
    def sample_size_rows(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def sample_size_rows(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class DatasetFromDatasource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = datarobot.DatasetFromDatasource("example",
            datasource_id=example_datarobot_datasource["id"],
            credential_id=example_datarobot_credential["id"],
            do_snapshot=False,
            persist_data_after_ingestion=False,
            use_kerberos=True,
            categories=["TRAINING"],
            use_case_ids=[example_datarobot_use_case["id"]])
    ...
    def get(resource_name: str,
            ...
            sample_size_rows: pulumi.Input[Optional[_builtins.int]] = None,
            use_case_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            use_kerberos: pulumi.Input[Optional[_builtins.bool]] = None) -> 'DatasetFromDatasource':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="doSnapshot")
    def do_snapshot(self) -> pulumi.Output[_builtins.bool]:
        """
        If unset, uses the server default: True. If true, creates a snapshot dataset; if false, creates a remote dataset.
        """
        return pulumi.get(self, "do_snapshot")
    ...
    @_builtins.property
    @pulumi.getter(name="persistDataAfterIngestion")
    def persist_data_after_ingestion(self) -> pulumi.Output[_builtins.bool]:
        """
        If unset, uses the server default: True. If true, will enforce saving all data (for download and sampling) and will allow a user to view extended data profile (which includes data statistics like min/max/median/mean, histogram, etc.). If false, will not enforce saving data. The data schema (feature names and types) still will be available.
        """
        return pulumi.get(self, "persist_data_after_ingestion")
    ...
    @_builtins.property
    @pulumi.getter(name="sampleSizeRows")
    def sample_size_rows(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of rows fetched during dataset registration.
        """
        return pulumi.get(self, "sample_size_rows")
    ...
    @_builtins.property
    @pulumi.getter(name="useKerberos")
    def use_kerberos(self) -> pulumi.Output[_builtins.bool]:
        """
        If unset, uses the server default: False. If true, use kerberos authentication for database authentication.
        """
        return pulumi.get(self, "use_kerberos")
