...
class GetExecutionEnvironmentResult:
    ...
    def programming_language(self) -> _builtins.str:
        """
...
def get_execution_environment(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the Execution Environment. Either <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`" pulumi-lang-hcl="`id`">`id`</span> or <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`" pulumi-lang-hcl="`name`">`name`</span> must be provided.
    :param _builtins.str name: The name of the Execution Environment. Either <span pulumi-lang-nodejs="`id`" pulumi-lang-dotnet="`Id`" pulumi-lang-go="`id`" pulumi-lang-python="`id`" pulumi-lang-yaml="`id`" pulumi-lang-java="`id`" pulumi-lang-hcl="`id`">`id`</span> or <span pulumi-lang-nodejs="`name`" pulumi-lang-dotnet="`Name`" pulumi-lang-go="`name`" pulumi-lang-python="`name`" pulumi-lang-yaml="`name`" pulumi-lang-java="`name`" pulumi-lang-hcl="`name`">`name`</span> must be provided.
    :param _builtins.str version_id: The ID of the Execution Environment Version.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_execution_environment_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
