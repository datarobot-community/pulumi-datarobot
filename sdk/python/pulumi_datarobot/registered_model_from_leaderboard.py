...
class RegisteredModelFromLeaderboardArgs:
    def __init__(__self__, *,
                 ...
                 compute_all_ts_intervals: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 distribution_prediction_model_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] model_id: The ID of the DataRobot model for this Registered Model.
        :param pulumi.Input[builtins.bool] compute_all_ts_intervals: Whether to compute all time series intervals (1-100 percentiles).
        :param pulumi.Input[builtins.str] description: The description of the Registered Model.
        :param pulumi.Input[builtins.str] distribution_prediction_model_id: The ID of the DataRobot distribution prediction model trained on predictions from the DataRobot model.
        :param pulumi.Input[builtins.str] name: The name of the Registered Model.
        :param pulumi.Input[builtins.float] prediction_threshold: The prediction threshold for the model.
    ...
    def compute_all_ts_intervals(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def compute_all_ts_intervals(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def distribution_prediction_model_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def distribution_prediction_model_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RegisteredModelFromLeaderboard(pulumi.CustomResource):
    ...
    pulumi_type = "datarobot:index/registeredModelFromLeaderboard:RegisteredModelFromLeaderboard"
    ...
    def get(resource_name: str,
            ...
            use_case_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            version_id: Optional[pulumi.Input[builtins.str]] = None,
            version_name: Optional[pulumi.Input[builtins.str]] = None) -> 'RegisteredModelFromLeaderboard':
        """
    ...
    @property
    @pulumi.getter(name="computeAllTsIntervals")
    def compute_all_ts_intervals(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to compute all time series intervals (1-100 percentiles).
        """
        return pulumi.get(self, "compute_all_ts_intervals")
    ...
    @property
    @pulumi.getter(name="distributionPredictionModelId")
    def distribution_prediction_model_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the DataRobot distribution prediction model trained on predictions from the DataRobot model.
        """
        return pulumi.get(self, "distribution_prediction_model_id")
