...
class PredictionEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 batch_jobs_max_concurrent: Optional[pulumi.Input[builtins.int]] = None,
                 batch_jobs_priority: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 supported_model_formats: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a PredictionEnvironment resource.
        :param pulumi.Input[builtins.str] platform: The platform for the Prediction Environment.
        :param pulumi.Input[builtins.int] batch_jobs_max_concurrent: The maximum number of concurrent batch prediction jobs.
        :param pulumi.Input[builtins.str] batch_jobs_priority: The importance of batch jobs.
        :param pulumi.Input[builtins.str] credential_id: The ID of the credential associated with the data connection. Only applicable for external prediction environments managed by DataRobot.
        :param pulumi.Input[builtins.str] datastore_id: The ID of the data store connection configuration. Only applicable for external prediction environments managed by DataRobot.
        :param pulumi.Input[builtins.str] description: The description of the Prediction Environment.
        :param pulumi.Input[builtins.str] managed_by: Determines if the prediction environment should be managed by the management agent, datarobot, or self-managed. Self-managed by default.
        :param pulumi.Input[builtins.str] name: The name of the Prediction Environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_model_formats: The list of supported model formats.
        """
    ...
    def batch_jobs_max_concurrent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def batch_jobs_max_concurrent(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_jobs_max_concurrent", value)

    @property
    @pulumi.getter(name="batchJobsPriority")
    def batch_jobs_priority(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def batch_jobs_priority(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def supported_model_formats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def supported_model_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PredictionEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            platform: Optional[pulumi.Input[builtins.str]] = None,
            supported_model_formats: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'PredictionEnvironment':
        """
    ...
    @property
    @pulumi.getter(name="batchJobsMaxConcurrent")
    def batch_jobs_max_concurrent(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum number of concurrent batch prediction jobs.
        """
        return pulumi.get(self, "batch_jobs_max_concurrent")
    ...
    @property
    @pulumi.getter(name="batchJobsPriority")
    def batch_jobs_priority(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The importance of batch jobs.
        """
        return pulumi.get(self, "batch_jobs_priority")
    ...
    @property
    @pulumi.getter(name="credentialId")
    def credential_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the credential associated with the data connection. Only applicable for external prediction environments managed by DataRobot.
        """
        return pulumi.get(self, "credential_id")
    ...
    @property
    @pulumi.getter(name="datastoreId")
    def datastore_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the data store connection configuration. Only applicable for external prediction environments managed by DataRobot.
        """
        return pulumi.get(self, "datastore_id")
    ...
    @property
    @pulumi.getter(name="supportedModelFormats")
    def supported_model_formats(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of supported model formats.
        """
        return pulumi.get(self, "supported_model_formats")
