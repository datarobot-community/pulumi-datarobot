...
class PredictionEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 batch_jobs_max_concurrent: pulumi.Input[Optional[_builtins.int]] = None,
                 batch_jobs_priority: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 supported_model_formats: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a PredictionEnvironment resource.

        :param pulumi.Input[_builtins.str] platform: The platform for the Prediction Environment.
        :param pulumi.Input[_builtins.int] batch_jobs_max_concurrent: The maximum number of concurrent batch prediction jobs.
        :param pulumi.Input[_builtins.str] batch_jobs_priority: The importance of batch jobs.
        :param pulumi.Input[_builtins.str] credential_id: The ID of the credential associated with the data connection. Only applicable for external prediction environments managed by DataRobot.
        :param pulumi.Input[_builtins.str] datastore_id: The ID of the data store connection configuration. Only applicable for external prediction environments managed by DataRobot.
        :param pulumi.Input[_builtins.str] description: The description of the Prediction Environment.
        :param pulumi.Input[_builtins.str] managed_by: Determines if the prediction environment should be managed by the management agent, datarobot, or self-managed. Self-managed by default.
        :param pulumi.Input[_builtins.str] name: The name of the Prediction Environment.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] supported_model_formats: The list of supported model formats.
        """
    ...
    def batch_jobs_max_concurrent(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def batch_jobs_max_concurrent(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "batch_jobs_max_concurrent", value)

    @_builtins.property
    @pulumi.getter(name="batchJobsPriority")
    def batch_jobs_priority(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def batch_jobs_priority(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def supported_model_formats(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def supported_model_formats(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class PredictionEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            platform: pulumi.Input[Optional[_builtins.str]] = None,
            supported_model_formats: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'PredictionEnvironment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="batchJobsMaxConcurrent")
    def batch_jobs_max_concurrent(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The maximum number of concurrent batch prediction jobs.
        """
        return pulumi.get(self, "batch_jobs_max_concurrent")
    ...
    @_builtins.property
    @pulumi.getter(name="batchJobsPriority")
    def batch_jobs_priority(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The importance of batch jobs.
        """
        return pulumi.get(self, "batch_jobs_priority")
    ...
    @_builtins.property
    @pulumi.getter(name="datastoreId")
    def datastore_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the data store connection configuration. Only applicable for external prediction environments managed by DataRobot.
        """
        return pulumi.get(self, "datastore_id")
    ...
    @_builtins.property
    @pulumi.getter(name="supportedModelFormats")
    def supported_model_formats(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The list of supported model formats.
        """
        return pulumi.get(self, "supported_model_formats")
