...
//				return err
//			}
//			examplePlayground, err := datarobot.NewPlayground(ctx, "example", &datarobot.PlaygroundArgs{
//				Name:        pulumi.String("An example playground"),
...
//				return err
//			}
//			exampleLlmBlueprint, err := datarobot.NewLlmBlueprint(ctx, "example", &datarobot.LlmBlueprintArgs{
//				Name:         pulumi.String("An example LLM blueprint"),
//				Description:  pulumi.String("Description for the example LLM blueprint"),
//				PlaygroundId: examplePlayground.ID().ToIDOutput().ToStringOutput(),
//				LlmId:        pulumi.String("azure-openai-gpt-4-o-mini"),
//				PromptType:   pulumi.String("ONE_TIME_PROMPT"),
//				LlmSettings: &datarobot.LlmBlueprintLlmSettingsArgs{
//					MaxCompletionLength: pulumi.Int(1000),
//					Temperature:         pulumi.Float64(0.5),
//					TopP:                pulumi.Float64(0.9),
//					SystemPrompt:        pulumi.String("My Prompt:"),
//				},
//				CustomModelLlmSettings: &datarobot.LlmBlueprintCustomModelLlmSettingsArgs{
//					ExternalLlmContextSize: pulumi.Int(100),
//					SystemPrompt:           pulumi.String("My Prompt:"),
//					ValidationId:           pulumi.String("111111111111"),
//				},
//				VectorDatabaseSettings: &datarobot.LlmBlueprintVectorDatabaseSettingsArgs{
//					MaxDocumentsRetrievedPerPrompt: pulumi.Int(5),
//					MaxTokens:                      pulumi.Int(1000),
//				},
//			})
//			if err != nil {
//				return err
