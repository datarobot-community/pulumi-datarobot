...
//			_, err := datarobot.NewRemoteRepository(ctx, "github_example", &datarobot.RemoteRepositoryArgs{
//				Name:        pulumi.String("An example GitHub remote repository"),
...
//				return err
//			}
//			_, err = datarobot.NewRemoteRepository(ctx, "gitlab_example", &datarobot.RemoteRepositoryArgs{
//				Name:                pulumi.String("An example GitLab remote repository"),
...
//				return err
//			}
//			_, err = datarobot.NewRemoteRepository(ctx, "bitbucket_example", &datarobot.RemoteRepositoryArgs{
//				Name:       pulumi.String("An example BitBucket remote repository"),
...
//				return err
//			}
//			_, err = datarobot.NewRemoteRepository(ctx, "s3_example", &datarobot.RemoteRepositoryArgs{
//				Name:       pulumi.String("An example S3 remote repository"),
