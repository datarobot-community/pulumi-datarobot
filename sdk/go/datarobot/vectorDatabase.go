...
//				Name:        pulumi.String("An example use case"),
//				Description: pulumi.String("Description for the example use case"),
//			})
//			if err != nil {
//				return err
//			}
//			exampleDatasetFromFile, err := datarobot.NewDatasetFromFile(ctx, "example", &datarobot.DatasetFromFileArgs{
...
//				return err
//			}
//			exampleVectorDatabase, err := datarobot.NewVectorDatabase(ctx, "example", &datarobot.VectorDatabaseArgs{
//				Name:      pulumi.String("An example vector database"),
//				UseCaseId: example.ID().ToIDOutput().ToStringOutput(),
//				DatasetId: exampleDatasetFromFile.ID().ToIDOutput().ToStringOutput(),
//			})
//			if err != nil {
//				return err
//			}
