...
//			batchPredictionJobDefinition, err := datarobot.NewCustomModel(ctx, "batch_prediction_job_definition", &datarobot.CustomModelArgs{
...
//				return err
//			}
//			batchPredictionJobDefinitionRegisteredModel, err := datarobot.NewRegisteredModel(ctx, "batch_prediction_job_definition", &datarobot.RegisteredModelArgs{
...
//				return err
//			}
//			batchPredictionJobDefinitionPredictionEnvironment, err := datarobot.NewPredictionEnvironment(ctx, "batch_prediction_job_definition", &datarobot.PredictionEnvironmentArgs{
...
//				return err
//			}
//			batchPredictionJobDefinitionDeployment, err := datarobot.NewDeployment(ctx, "batch_prediction_job_definition", &datarobot.DeploymentArgs{
//				Label:                    pulumi.String("An example deployment"),
//				PredictionEnvironmentId:  batchPredictionJobDefinitionPredictionEnvironment.ID().ToIDOutput().ToStringOutput(),
//				RegisteredModelVersionId: batchPredictionJobDefinitionRegisteredModel.VersionId,
//			})
//			if err != nil {
//				return err
//			}
//			batchPredictionJobDefinitionBasicCredential, err := datarobot.NewBasicCredential(ctx, "batch_prediction_job_definition", &datarobot.BasicCredentialArgs{
//				Name:     pulumi.String("Example Basic Credential"),
...
//				return err
//			}
//			example, err := datarobot.NewBatchPredictionJobDefinition(ctx, "example", &datarobot.BatchPredictionJobDefinitionArgs{
//				Name:         pulumi.String("Example Batch Prediction Job Definition"),
//				DeploymentId: batchPredictionJobDefinitionDeployment.ID().ToIDOutput().ToStringOutput(),
//				IntakeSettings: &datarobot.BatchPredictionJobDefinitionIntakeSettingsArgs{
//					Type:         pulumi.String("s3"),
//					Url:          pulumi.String("s3://datarobot-public-datasets-redistributable/1k_diabetes_simplified_features.csv"),
//					CredentialId: batchPredictionJobDefinitionBasicCredential.ID().ToIDOutput().ToStringOutput(),
//				},
//				OutputSettings: &datarobot.BatchPredictionJobDefinitionOutputSettingsArgs{
//					Type:         pulumi.String("s3"),
//					Url:          pulumi.String("s3://my-test-bucket/predictions.csv"),
//					CredentialId: batchPredictionJobDefinitionBasicCredential.ID().ToIDOutput().ToStringOutput(),
//				},
//				CsvSettings: &datarobot.BatchPredictionJobDefinitionCsvSettingsArgs{
//					Delimiter: pulumi.String("."),
//					Quotechar: pulumi.String("'"),
//					Encoding:  pulumi.String("utf-8"),
//				},
//				NumConcurrent:           pulumi.Int(1),
//				ChunkSize:               pulumi.Any(10),
//				MaxExplanations:         pulumi.Int(5),
//				ThresholdHigh:           pulumi.Float64(0.8),
//				ThresholdLow:            pulumi.Float64(0.2),
//				PredictionThreshold:     pulumi.Float64(0.5),
//				IncludePredictionStatus: pulumi.Bool(true),
//				SkipDriftTracking:       pulumi.Bool(true),
//				PassthroughColumnsSet:   pulumi.String("all"),
//				AbortOnError:            pulumi.Bool(false),
//				IncludeProbabilities:    pulumi.Bool(true),
//				ColumnNamesRemapping: pulumi.StringMap{
//					"col1": pulumi.String("newCol1"),
//				},
