...
//			example, err := datarobot.NewUseCase(ctx, "example", &datarobot.UseCaseArgs{
//				Name: pulumi.String("Example use case"),
//			})
//			if err != nil {
//				return err
//			}
//			exampleCustomModel, err := datarobot.NewCustomModel(ctx, "example", &datarobot.CustomModelArgs{
...
//				return err
//			}
//			exampleCustomJob, err := datarobot.NewCustomJob(ctx, "example", &datarobot.CustomJobArgs{
//				Name:          pulumi.String("Example Custom Job"),
...
//				return err
//			}
//			exampleDeploymentRetrainingPolicy, err := datarobot.NewDeploymentRetrainingPolicy(ctx, "example", &datarobot.DeploymentRetrainingPolicyArgs{
//				DeploymentId:           exampleDeployment.ID().ToIDOutput().ToStringOutput(),
//				Name:                   pulumi.String("Example Deployment Retraining Policy"),
//				Description:            pulumi.String("Example Description"),
//				Action:                 pulumi.String("create_model_package"),
//				ModelSelectionStrategy: pulumi.String("custom_job"),
//				FeatureListStrategy:    pulumi.String("informative_features"),
//				ProjectOptionsStrategy: pulumi.String("custom"),
//				Trigger: &datarobot.DeploymentRetrainingPolicyTriggerArgs{
//					CustomJobId: exampleCustomJob.ID().ToIDOutput().ToStringOutput(),
//				},
...
//				UseCaseId:         example.ID().ToIDOutput().ToStringOutput(),
//			})
//			if err != nil {
//				return err
//			}
//			ctx.Export("datarobotDeploymentRetrainingPolicyId", exampleDeploymentRetrainingPolicy.ID())
//			return nil
//		})
//	}
//
