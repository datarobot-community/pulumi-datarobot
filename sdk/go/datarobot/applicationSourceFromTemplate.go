...
//			example, err := datarobot.NewApplicationSourceFromTemplate(ctx, "example", &datarobot.ApplicationSourceFromTemplateArgs{
//				Name:              pulumi.String("example application source from template"),
//				TemplateId:        pulumi.String("67126757e7819551baceb22b"),
...
//					},
//				},
//				FolderPath: pulumi.String("example-app"),
...
//					ResourceLabel:   pulumi.String("cpu.medium"),
//				},
//			})
//			if err != nil {
//				return err
...
//			ctx.Export("datarobotApplicationSourceResources", example.Resources)
//			return nil
//		})
//	}
//
