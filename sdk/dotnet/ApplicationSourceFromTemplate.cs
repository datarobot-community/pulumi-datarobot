...
namespace DataRobotPulumi.Datarobot
{
    ...
    public partial class ApplicationSourceFromTemplate : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("files")]
        public Output<ImmutableArray<Outputs.ApplicationSourceFromTemplateFile>> Files { get; private set; } = null!;
    ...
    public sealed class ApplicationSourceFromTemplateArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("files")]
        private InputList<Inputs.ApplicationSourceFromTemplateFileArgs>? _files;

        /// <summary>
        /// List of files to upload, each with a source (local path) and destination (path in application source).
        /// </summary>
        public InputList<Inputs.ApplicationSourceFromTemplateFileArgs> Files
        {
            get => _files ?? (_files = new InputList<Inputs.ApplicationSourceFromTemplateFileArgs>());
            set => _files = value;
        }
    ...
    public sealed class ApplicationSourceFromTemplateState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("files")]
        private InputList<Inputs.ApplicationSourceFromTemplateFileGetArgs>? _files;

        /// <summary>
        /// List of files to upload, each with a source (local path) and destination (path in application source).
        /// </summary>
        public InputList<Inputs.ApplicationSourceFromTemplateFileGetArgs> Files
        {
            get => _files ?? (_files = new InputList<Inputs.ApplicationSourceFromTemplateFileGetArgs>());
            set => _files = value;
        }
