...
namespace DataRobotPulumi.Datarobot.Inputs
{
    ...
    public sealed class DeploymentRetrainingPolicyTriggerGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("schedule")]
        public Input<Inputs.DeploymentRetrainingPolicyTriggerScheduleGetArgs>? Schedule { get; set; }
        ...
        public DeploymentRetrainingPolicyTriggerGetArgs()
        {
        }
        public static new DeploymentRetrainingPolicyTriggerGetArgs Empty => new DeploymentRetrainingPolicyTriggerGetArgs();
    }
}
