...
namespace DataRobotPulumi.Datarobot.Inputs
{
    ...
    public sealed class CustomMetricFromJobScheduleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public CustomMetricFromJobScheduleArgs()
        {
        }
        public static new CustomMetricFromJobScheduleArgs Empty => new CustomMetricFromJobScheduleArgs();
    }
}
