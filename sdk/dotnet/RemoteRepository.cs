...
namespace DataRobotPulumi.Datarobot
{
    ...
    /// {
    ///     var githubExample = new Datarobot.RemoteRepository("github_example", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var gitlabExample = new Datarobot.RemoteRepository("gitlab_example", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var bitbucketExample = new Datarobot.RemoteRepository("bitbucket_example", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var s3Example = new Datarobot.RemoteRepository("s3_example", new()
    ///     {
