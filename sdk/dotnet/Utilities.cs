...
namespace DataRobotPulumi.Datarobot
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("DataRobotPulumi.Datarobot.version.txt");
    ...
    internal sealed class DatarobotResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DatarobotResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
