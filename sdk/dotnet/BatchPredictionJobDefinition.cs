...
namespace DataRobotPulumi.Datarobot
{
    ...
    /// {
    ///     var batchPredictionJobDefinition = new Datarobot.CustomModel("batch_prediction_job_definition", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var batchPredictionJobDefinitionRegisteredModel = new Datarobot.RegisteredModel("batch_prediction_job_definition", new()
    ///     {
    ///         CustomModelVersionId = batchPredictionJobDefinition.VersionId,
    ///         Name = "Example Registered Model",
    ///     });
    /// 
    ///     var batchPredictionJobDefinitionPredictionEnvironment = new Datarobot.PredictionEnvironment("batch_prediction_job_definition", new()
    ///     {
    ///         Name = "Example Prediction Environment",
    ///         Platform = "datarobotServerless",
    ///     });
    /// 
    ///     var batchPredictionJobDefinitionDeployment = new Datarobot.Deployment("batch_prediction_job_definition", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var batchPredictionJobDefinitionBasicCredential = new Datarobot.BasicCredential("batch_prediction_job_definition", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var example = new Datarobot.BatchPredictionJobDefinition("example", new()
    ///     {
