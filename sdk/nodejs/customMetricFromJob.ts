 ...
 *     customJobId: exampleDatarobotCustomMetricJob.id,
 * });
...
export class CustomMetricFromJob extends pulumi.CustomResource {
     ...
     */
    declare public readonly batch: pulumi.Output<outputs.CustomMetricFromJobBatch | undefined>;
    /**
     * ID of the Custom Job.
     */
    declare public readonly customJobId: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly parameterOverrides: pulumi.Output<outputs.CustomMetricFromJobParameterOverride[] | undefined>;
    /**
     * Points to a weight column if users provide pre-aggregated metric values. Used with columnar datasets.
     */
    declare public readonly sampleCount: pulumi.Output<outputs.CustomMetricFromJobSampleCount | undefined>;
    /**
     * Defines at what intervals the metric job should run.
     */
    declare public readonly schedule: pulumi.Output<outputs.CustomMetricFromJobSchedule | undefined>;
    /**
     ...
     */
    declare public readonly timestamp: pulumi.Output<outputs.CustomMetricFromJobTimestamp | undefined>;
    /**
     * Value source when reading values from columnar dataset like a file.
     */
    declare public readonly value: pulumi.Output<outputs.CustomMetricFromJobValue | undefined>;
    ...
    constructor(name: string, argsOrState?: CustomMetricFromJobArgs | CustomMetricFromJobState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["customJobId"] = state?.customJobId;
            ...
            if (args?.customJobId === undefined && !opts.urn) {
            ...
            resourceInputs["customJobId"] = args?.customJobId;
...
export interface CustomMetricFromJobState {
     ...
     * Batch ID source when reading values from columnar dataset like a file.
     */
    batch?: pulumi.Input<inputs.CustomMetricFromJobBatch | undefined>;
    /**
     * ID of the Custom Job.
     */
     ...
     * Additional parameters to be injected into the Metric Job at runtime.
     */
    parameterOverrides?: pulumi.Input<pulumi.Input<inputs.CustomMetricFromJobParameterOverride>[] | undefined>;
    /**
     * Points to a weight column if users provide pre-aggregated metric values. Used with columnar datasets.
     */
    sampleCount?: pulumi.Input<inputs.CustomMetricFromJobSampleCount | undefined>;
    /**
     * Defines at what intervals the metric job should run.
     */
    schedule?: pulumi.Input<inputs.CustomMetricFromJobSchedule | undefined>;
    /**
     * Timestamp spoofing when reading values from file, like dataset. By default, we replicate pd.to_datetime formatting behaviour.
     */
    timestamp?: pulumi.Input<inputs.CustomMetricFromJobTimestamp | undefined>;
    /**
     * Value source when reading values from columnar dataset like a file.
     */
    value?: pulumi.Input<inputs.CustomMetricFromJobValue | undefined>;
}
