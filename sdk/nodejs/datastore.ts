 ...
 *     }],
 * });
 * const exampleJdbc = new datarobot.Datastore("example_jdbc", {
...
export class Datastore extends pulumi.CustomResource {
     ...
     */
    declare public readonly driverId: pulumi.Output<string | undefined>;
    /**
     * If the type is dr-database-v1, then the fields specify the configuration.
     */
    declare public readonly fields: pulumi.Output<{[key: string]: string}[] | undefined>;
    /**
     * The full JDBC URL (for example: jdbc:postgresql://my.dbaddress.org:5432/my_db).
     */
    declare public readonly jdbcUrl: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: DatastoreArgs | DatastoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["jdbcUrl"] = args?.jdbcUrl;
        }
...
export interface DatastoreState {
     ...
     * The identifier of the DataDriver if data*store*type is JDBC or DR*DATABASE*V1
     */
    driverId?: pulumi.Input<string | undefined>;
    /**
     * If the type is dr-database-v1, then the fields specify the configuration.
     */
    fields?: pulumi.Input<pulumi.Input<{[key: string]: pulumi.Input<string>}>[] | undefined>;
    /**
     * The full JDBC URL (for example: jdbc:postgresql://my.dbaddress.org:5432/my_db).
     */
