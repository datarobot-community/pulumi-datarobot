...
export class NotificationPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly channelScope: pulumi.Output<string>;
    /**
     * The group of the events that trigger the Notification.
     */
    declare public readonly eventGroup: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly maximalFrequency: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NotificationPolicyArgs | NotificationPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["channelScope"] = state?.channelScope;
            resourceInputs["eventGroup"] = state?.eventGroup;
            resourceInputs["eventType"] = state?.eventType;
            resourceInputs["maximalFrequency"] = state?.maximalFrequency;
            ...
            if (args?.channelScope === undefined && !opts.urn) {
            ...
            resourceInputs["channelScope"] = args?.channelScope;
            resourceInputs["eventGroup"] = args?.eventGroup;
            resourceInputs["eventType"] = args?.eventType;
            resourceInputs["maximalFrequency"] = args?.maximalFrequency;
...
export interface NotificationPolicyState {
     ...
     * The Channel scope of the Notification Policy.
     */
    channelScope?: pulumi.Input<string | undefined>;
    /**
     * The group of the events that trigger the Notification.
     */
    eventGroup?: pulumi.Input<string | undefined>;
    /**
     * The group of the event that triggers the Notification.
     */
     ...
     * The maximal frequency between policy runs in ISO 8601 duration string.
     */
    maximalFrequency?: pulumi.Input<string | undefined>;
    /**
     * The name of the Notification Policy.
     */
