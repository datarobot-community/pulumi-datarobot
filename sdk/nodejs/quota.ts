...
export class Quota extends pulumi.CustomResource {
     ...
     */
    declare public readonly defaultRules: pulumi.Output<outputs.QuotaDefaultRule[]>;
    /**
...
export interface QuotaState {
     ...
     * The default rate-limit rules applied to all consumers.
     */
    defaultRules?: pulumi.Input<pulumi.Input<inputs.QuotaDefaultRule>[] | undefined>;
    /**
     * The ID of the resource (e.g. the Deployment) the quota governs.
     */
