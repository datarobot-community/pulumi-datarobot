...
export class ExecutionEnvironment extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly dockerContextHash: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly dockerImageHash: pulumi.Output<string>;
    /**
     * The URI of a pre-built environment image (e.g., in a remote Docker registry).
     */
    declare public readonly dockerImageUri: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ExecutionEnvironmentArgs | ExecutionEnvironmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dockerContextHash"] = state?.dockerContextHash;
            resourceInputs["dockerContextPath"] = state?.dockerContextPath;
            resourceInputs["dockerImage"] = state?.dockerImage;
            resourceInputs["dockerImageHash"] = state?.dockerImageHash;
            resourceInputs["dockerImageUri"] = state?.dockerImageUri;
            ...
            if (args?.programmingLanguage === undefined && !opts.urn) {
            ...
            resourceInputs["dockerImageUri"] = args?.dockerImageUri;
...
export interface ExecutionEnvironmentState {
     ...
     * The hash of the docker context contents.
     */
    dockerContextHash?: pulumi.Input<string | undefined>;
    /**
     * The path to a docker context archive or folder
     */
     ...
     * The hash of the docker image file
     */
    dockerImageHash?: pulumi.Input<string | undefined>;
    /**
     * The URI of a pre-built environment image (e.g., in a remote Docker registry).
     */
    dockerImageUri?: pulumi.Input<string | undefined>;
    /**
     * The name of the Execution Environment.
     */
