...
# from test_pipeline_lukas_1_1.hooks import ProjectHooks
from test_pipeline_lukas_1_1.hooks import ExtraCredentialsHooks
...
# reported analytics.
HOOKS = (AnalyticsHooks("docsassist"),) + HOOKS
